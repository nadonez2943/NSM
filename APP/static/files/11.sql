CREATE DATABASE  IF NOT EXISTS `nsm_project` /*!40100 DEFAULT CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `nsm_project`;
...
CREATE TABLE `board` (
  ...
  `pj_id` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `role_id` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dateTime` datetime(6) DEFAULT NULL,
  `bo_phase` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`bo_id`)
...
INSERT INTO `board` VALUES (3,'1','2','2',NULL,'1'),(4,'2','2','1',NULL,'1'),(5,'3','3','2',NULL,'1'),(6,'2','3','1',NULL,'1'),(7,'1','3','2',NULL,'1'),(8,'4','1','3',NULL,'1'),(9,'4','2','3',NULL,'1'),(10,'4','3','3',NULL,'1'),(14,'2','2','1',NULL,'2'),(15,'3','2','1',NULL,'3'),(56,'1','1','1',NULL,'2'),(58,'2','1','2',NULL,'2'),(59,'3','1','1',NULL,'3'),(61,'1','1','2',NULL,'3'),(62,'2','1','2',NULL,'1'),(63,'1','1','1',NULL,'1');
...
CREATE TABLE `checks` (
  ...
  `pj_id` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ins_no` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `conNo` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `check_date` date DEFAULT NULL,
  `check_detail` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ins_date` date DEFAULT NULL,
  `ins_amount` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `contractor` (
  ...
  `contt_tel` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `contractor` VALUES (1,'บริษัท จำกัด ไม่จำกัด','Asguard','022212121','hi5@email.com','2023-01-05','2023-01-22','2023-02-22');
...
CREATE TABLE `division` (
  ...
  `of_id` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `events` (
  ...
  `ev_phase` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `events` VALUES (1,'1','ประชุมครั้งที่ 1','1','2022-09-24',' มี','15:30:00'),(2,'2','ประชุม 2','1','2022-11-05','เรื่องงบประมาณ','12:00:00'),(3,'3','ประชุม 3 ','1','2022-08-09','สังสรรค์','13:00:00'),(4,'3','ประชุม 4','2','2022-09-11','เรื่องบริษัท','10:30:00'),(5,'2','ประชุม 5','2','2022-10-06','เรื่องอะไรดี','15:00:00'),(6,'1','ประชุมม 6','2','2022-09-21','นั่น','11:15:00'),(8,'1','ประชุม 8','1','2029-04-05','ยู้ฮู','14:30:00'),(23,'2','zdfg','1','2022-09-20','arag','07:00:00'),(24,'2','afg','1','2022-09-20','asfdgs',NULL),(25,'2','sdag','2','2022-09-29','afgadfg',NULL),(26,'2','ประชุม','3','2022-09-14','การเงิน','12:00:00'),(27,'3','ประชุมใหม่','3','2022-10-05','การประชุม','12:00:00');
...
INSERT INTO `manager` VALUES (1,'1','1'),(2,'1','2'),(3,'1','3'),(4,'1','4');
...
CREATE TABLE `pacel` (
  ...
  `pac_detail` varchar(250) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `path` (
  ...
  `pj_id` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `path_phase` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `process` VALUES (1,'1',3,4,4,1,'2022-12-11',NULL,'2022-12-20',NULL),(2,'2',3,2,1,1,'2022-11-10',NULL,'2022-12-10',NULL),(3,'3',4,4,2,1,'2022-06-15',NULL,'2022-07-30',NULL),(4,'4',1,1,1,NULL,'2022-10-06',NULL,'2022-10-11',NULL);
...
CREATE TABLE `projects` (
  ...
  `of_id` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dv_id` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `pj_amount` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pj_detail` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pj_financeAmount` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `status_draft` VALUES (1,'-',0),(2,'ขออนุมัติแต่งตั้งผู้รับผิดชอบ',20),(3,'ขอความเห็นชอบร่างขอบเขต',40),(4,'ดำเนินการร่างขอบเขต',60),(7,'เสนอขออนุมัติ',80),(8,'เสร็จสิ้น',100);
...
INSERT INTO `users` VALUES (1,'user1','พงศกร จันทร์สว่าง','aa@email.com','123','user','02122333','1','2'),(2,'user2','นฤดล เจริญรุ่งเรือง','bb@email.com','123','user','06145216','3','10'),(3,'user3','พีรพล พาร์คเกอร์','cc@email.com','123','user','05412356','4','12'),(4,'user4','ปาริฉัตร นาราทิพย์','dd@email.com','123','user','23134643','10','30');
...
-- Dump completed on 2022-10-10 14:35:35
