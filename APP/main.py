...
def home():
    if session['user_role']=="user":
        ...
        try:
            ...
            cursor.execute("SELECT *,ROW_NUMBER() OVER(ORDER BY nsm_project.projects.pj_id) as row_num ,CAST(((stdraft_percent+stcon_percent+stex_percent)/3) AS DECIMAL(15, 2)) as x FROM nsm_project.projects LEFT JOIN nsm_project.process ON nsm_project.projects.pj_id = nsm_project.process.pj_id LEFT JOIN nsm_project.status_draft ON nsm_project.process.stdraft_id = nsm_project.status_draft.stdraft_id LEFT JOIN nsm_project.status_consider ON nsm_project.process.stcon_id = nsm_project.status_consider.stcon_id LEFT JOIN nsm_project.status_examine ON nsm_project.process.stex_id = nsm_project.status_examine.stex_id LEFT JOIN nsm_project.events ON nsm_project.projects.pj_id = nsm_project.events.pj_id LEFT JOIN nsm_project.contractor ON nsm_project.process.contt_id = nsm_project.contractor.contt_id LEFT JOIN nsm_project.manager ON nsm_project.projects.pj_id = nsm_project.manager.mn_id  LEFT JOIN nsm_project.users ON nsm_project.manager.user_id = nsm_project.users.user_id LEFT JOIN nsm_project.board ON nsm_project.projects.pj_id = nsm_project.board.pj_id WHERE nsm_project.manager.user_id = %s and nsm_project.projects.pj_status = 1 group by nsm_project.projects.pj_id order by nsm_project.projects.pj_id asc, nsm_project.events.ev_id desc",session['user_id'])
            MN = cursor.fetchall()
            cursor.execute("SELECT *,ROW_NUMBER() OVER(ORDER BY nsm_project.projects.pj_id) as row_num ,CAST(((stdraft_percent+stcon_percent+stex_percent)/3) AS DECIMAL(15, 2)) as x FROM nsm_project.projects LEFT JOIN nsm_project.process ON nsm_project.projects.pj_id = nsm_project.process.pj_id LEFT JOIN nsm_project.status_draft ON nsm_project.process.stdraft_id = nsm_project.status_draft.stdraft_id LEFT JOIN nsm_project.status_consider ON nsm_project.process.stcon_id = nsm_project.status_consider.stcon_id LEFT JOIN nsm_project.status_examine ON nsm_project.process.stex_id = nsm_project.status_examine.stex_id LEFT JOIN nsm_project.events ON nsm_project.projects.pj_id = nsm_project.events.pj_id LEFT JOIN nsm_project.contractor ON nsm_project.process.contt_id = nsm_project.contractor.contt_id LEFT JOIN nsm_project.manager ON nsm_project.projects.pj_id = nsm_project.manager.mn_id  LEFT JOIN nsm_project.users ON nsm_project.manager.user_id = nsm_project.users.user_id LEFT JOIN nsm_project.board ON nsm_project.projects.pj_id = nsm_project.board.pj_id WHERE nsm_project.board.user_id = %s and nsm_project.projects.pj_status = 1 group by nsm_project.projects.pj_id order by nsm_project.projects.pj_id asc, nsm_project.events.ev_id desc",session['user_id'])
            BO = cursor.fetchall()
            cursor.execute("SELECT *,ROW_NUMBER() OVER(ORDER BY nsm_project.projects.pj_id) as row_num ,CAST(((stdraft_percent+stcon_percent+stex_percent)/3) AS DECIMAL(15, 2)) as x FROM nsm_project.projects LEFT JOIN nsm_project.process ON nsm_project.projects.pj_id = nsm_project.process.pj_id LEFT JOIN nsm_project.status_draft ON nsm_project.process.stdraft_id = nsm_project.status_draft.stdraft_id LEFT JOIN nsm_project.status_consider ON nsm_project.process.stcon_id = nsm_project.status_consider.stcon_id LEFT JOIN nsm_project.status_examine ON nsm_project.process.stex_id = nsm_project.status_examine.stex_id LEFT JOIN nsm_project.events ON nsm_project.projects.pj_id = nsm_project.events.pj_id LEFT JOIN nsm_project.contractor ON nsm_project.process.contt_id = nsm_project.contractor.contt_id LEFT JOIN nsm_project.manager ON nsm_project.projects.pj_id = nsm_project.manager.mn_id  LEFT JOIN nsm_project.users ON nsm_project.manager.user_id = nsm_project.users.user_id LEFT JOIN nsm_project.board ON nsm_project.projects.pj_id = nsm_project.board.pj_id WHERE nsm_project.board.user_id = %s and nsm_project.board.bo_phase = 1 and nsm_project.projects.pj_status = 1 group by nsm_project.projects.pj_id order by nsm_project.projects.pj_id asc, nsm_project.events.ev_id desc",session['user_id'])
            DR = cursor.fetchall()
            cursor.execute("SELECT *,ROW_NUMBER() OVER(ORDER BY nsm_project.projects.pj_id) as row_num ,CAST(((stdraft_percent+stcon_percent+stex_percent)/3) AS DECIMAL(15, 2)) as x FROM nsm_project.projects LEFT JOIN nsm_project.process ON nsm_project.projects.pj_id = nsm_project.process.pj_id LEFT JOIN nsm_project.status_draft ON nsm_project.process.stdraft_id = nsm_project.status_draft.stdraft_id LEFT JOIN nsm_project.status_consider ON nsm_project.process.stcon_id = nsm_project.status_consider.stcon_id LEFT JOIN nsm_project.status_examine ON nsm_project.process.stex_id = nsm_project.status_examine.stex_id LEFT JOIN nsm_project.events ON nsm_project.projects.pj_id = nsm_project.events.pj_id LEFT JOIN nsm_project.contractor ON nsm_project.process.contt_id = nsm_project.contractor.contt_id LEFT JOIN nsm_project.manager ON nsm_project.projects.pj_id = nsm_project.manager.mn_id  LEFT JOIN nsm_project.users ON nsm_project.manager.user_id = nsm_project.users.user_id LEFT JOIN nsm_project.board ON nsm_project.projects.pj_id = nsm_project.board.pj_id WHERE nsm_project.board.user_id = %s and nsm_project.board.bo_phase = 2 and nsm_project.projects.pj_status = 1 group by nsm_project.projects.pj_id order by nsm_project.projects.pj_id asc, nsm_project.events.ev_id desc",session['user_id'])
            CO = cursor.fetchall()
            cursor.execute("SELECT *,ROW_NUMBER() OVER(ORDER BY nsm_project.projects.pj_id) as row_num ,CAST(((stdraft_percent+stcon_percent+stex_percent)/3) AS DECIMAL(15, 2)) as x FROM nsm_project.projects LEFT JOIN nsm_project.process ON nsm_project.projects.pj_id = nsm_project.process.pj_id LEFT JOIN nsm_project.status_draft ON nsm_project.process.stdraft_id = nsm_project.status_draft.stdraft_id LEFT JOIN nsm_project.status_consider ON nsm_project.process.stcon_id = nsm_project.status_consider.stcon_id LEFT JOIN nsm_project.status_examine ON nsm_project.process.stex_id = nsm_project.status_examine.stex_id LEFT JOIN nsm_project.events ON nsm_project.projects.pj_id = nsm_project.events.pj_id LEFT JOIN nsm_project.contractor ON nsm_project.process.contt_id = nsm_project.contractor.contt_id LEFT JOIN nsm_project.manager ON nsm_project.projects.pj_id = nsm_project.manager.mn_id  LEFT JOIN nsm_project.users ON nsm_project.manager.user_id = nsm_project.users.user_id LEFT JOIN nsm_project.board ON nsm_project.projects.pj_id = nsm_project.board.pj_id WHERE nsm_project.board.user_id = %s and nsm_project.board.bo_phase = 3 and nsm_project.projects.pj_status = 1 group by nsm_project.projects.pj_id order by nsm_project.projects.pj_id asc, nsm_project.events.ev_id desc",session['user_id'])
            EX = cursor.fetchall()
            cursor.execute("SELECT *,ROW_NUMBER() OVER(ORDER BY nsm_project.projects.pj_id) as row_num ,CAST(((stdraft_percent+stcon_percent+stex_percent)/3) AS DECIMAL(15, 2)) as x FROM nsm_project.projects LEFT JOIN nsm_project.process ON nsm_project.projects.pj_id = nsm_project.process.pj_id LEFT JOIN nsm_project.status_draft ON nsm_project.process.stdraft_id = nsm_project.status_draft.stdraft_id LEFT JOIN nsm_project.status_consider ON nsm_project.process.stcon_id = nsm_project.status_consider.stcon_id LEFT JOIN nsm_project.status_examine ON nsm_project.process.stex_id = nsm_project.status_examine.stex_id LEFT JOIN nsm_project.events ON nsm_project.projects.pj_id = nsm_project.events.pj_id LEFT JOIN nsm_project.contractor ON nsm_project.process.contt_id = nsm_project.contractor.contt_id LEFT JOIN nsm_project.manager ON nsm_project.projects.pj_id = nsm_project.manager.mn_id  LEFT JOIN nsm_project.users ON nsm_project.manager.user_id = nsm_project.users.user_id LEFT JOIN nsm_project.board ON nsm_project.projects.pj_id = nsm_project.board.pj_id WHERE nsm_project.board.user_id = %s and nsm_project.projects.pj_status = 3 group by nsm_project.projects.pj_id order by nsm_project.projects.pj_id asc, nsm_project.events.ev_id desc",session['user_id'])
            En = cursor.fetchall()
            cursor.execute("SELECT * FROM (SELECT ROW_NUMBER() OVER(ORDER BY nsm_project.projects.pj_id) as row_num ,CAST(((stdraft_percent+stcon_percent+stex_percent)/3) AS DECIMAL(15, 2)) as x,nsm_project.projects.pj_name,nsm_project.projects.pj_refNumber,nsm_project.manager.user_id FROM nsm_project.projects LEFT JOIN nsm_project.process ON nsm_project.projects.pj_id = nsm_project.process.pj_id LEFT JOIN nsm_project.status_draft ON nsm_project.process.stdraft_id = nsm_project.status_draft.stdraft_id LEFT JOIN nsm_project.status_consider ON nsm_project.process.stcon_id = nsm_project.status_consider.stcon_id LEFT JOIN nsm_project.status_examine ON nsm_project.process.stex_id = nsm_project.status_examine.stex_id LEFT JOIN nsm_project.manager ON nsm_project.manager.pj_id = nsm_project.projects.pj_id LEFT JOIN nsm_project.board ON nsm_project.projects.pj_id = nsm_project.board.pj_id LEFT JOIN nsm_project.users ON nsm_project.users.user_id = nsm_project.board.user_id or nsm_project.users.user_id = nsm_project.manager.user_id WHERE nsm_project.users.user_id = %s and nsm_project.projects.pj_status = 2 group by nsm_project.projects.pj_id) a LEFT JOIN (SELECT * FROM nsm_project.users ) b ON a.user_id = b.user_id",session['user_id'])
            Su = cursor.fetchall()
            return render_template('home.html', BO=BO,MN=MN,DR=DR,CO=CO,EX=EX,En=En,Su=Su )
...
def project(id):
    ...
    try:
        ...
        pac = cursor.fetchall()
        cursor.execute("SELECT *,CASE  WHEN nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id = nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 1 AND nsm_project.process.stdraft_id < 5 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id = nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 2 AND nsm_project.process.stcon_id < 7 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id = nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 3 AND nsm_project.process.stex_id < 6 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id != nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 1 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id != nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 2 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id != nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 3 THEN 'chairman' WHEN nsm_project.manager.user_id = nsm_project.users.user_id AND IF(nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id = nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 1 AND nsm_project.process.stdraft_id < 5 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id = nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 2 AND nsm_project.process.stcon_id < 7 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id = nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 3 AND nsm_project.process.stex_id < 6 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id != nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 1 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id != nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 2 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id != nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 3, 1, 0) = 0 THEN 'manager' WHEN nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.board.role_id = 2 THEN 'board' WHEN nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.board.role_id = 3 THEN 'assistant' END AS role FROM nsm_project.process LEFT JOIN nsm_project.manager ON nsm_project.process.pj_id = nsm_project.manager.pj_id LEFT JOIN nsm_project.board ON nsm_project.process.pj_id = nsm_project.board.pj_id LEFT JOIN nsm_project.tbl_role ON nsm_project.board.role_id = nsm_project.tbl_role.role_id LEFT JOIN nsm_project.users ON nsm_project.board.user_id = nsm_project.users.user_id or nsm_project.manager.user_id = nsm_project.users.user_id Where nsm_project.process.pj_id = %s and nsm_project.users.user_id = %s order by nsm_project.board.bo_phase desc,nsm_project.board.role_id asc  LIMIT 1",(id ,user))
...
def draft(id):
    if session['user_role']=="user":
        ...
        try:
            ...
            cursor.execute("SELECT * FROM (SELECT null) a LEFT JOIN (SELECT nsm_project.board.bo_phase,CASE  WHEN nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id = nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 1 AND nsm_project.process.stdraft_id < 5 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id = nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 2 AND nsm_project.process.stcon_id < 7 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id = nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 3 AND nsm_project.process.stex_id < 6 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id != nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 1 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id != nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 2 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id != nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 3 THEN 'chairman' WHEN nsm_project.manager.user_id = nsm_project.users.user_id AND IF(nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id = nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 1 AND nsm_project.process.stdraft_id < 5 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id = nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 2 AND nsm_project.process.stcon_id < 7 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id = nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 3 AND nsm_project.process.stex_id < 6 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id != nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 1 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id != nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 2 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id != nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 3, 1, 0) = 0 THEN 'manager' WHEN nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.board.role_id = 2 THEN 'board' WHEN nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.board.role_id = 3 THEN 'assistant' END AS role FROM nsm_project.process LEFT JOIN nsm_project.manager ON nsm_project.process.pj_id = nsm_project.manager.pj_id LEFT JOIN nsm_project.board ON nsm_project.process.pj_id = nsm_project.board.pj_id LEFT JOIN nsm_project.tbl_role ON nsm_project.board.role_id = nsm_project.tbl_role.role_id LEFT JOIN nsm_project.users ON nsm_project.board.user_id = nsm_project.users.user_id or nsm_project.manager.user_id = nsm_project.users.user_id Where nsm_project.process.pj_id = %s and nsm_project.users.user_id = %s and nsm_project.board.bo_phase = 1 or nsm_project.process.pj_id = %s and nsm_project.users.user_id = %s and nsm_project.manager.user_id = nsm_project.users.user_id AND IF(nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id = nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 1 AND nsm_project.process.stdraft_id < 5 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id = nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 2 AND nsm_project.process.stcon_id < 7 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id = nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 3 AND nsm_project.process.stex_id < 6 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id != nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 1 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id != nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 2 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id != nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 3, 1, 0) = 0 order by nsm_project.board.bo_phase desc,nsm_project.board.role_id asc  LIMIT 1) b ON true ",(id ,user,id,user))
            role = cursor.fetchone()
            if (manager ==  role['role']) :
                ...
                if (assistant == role['role'] or role['role'] == "chairman") :
                    return render_template('draft.html', row=row , rows=rows ,id=id ,ev=ev,diff=diff,role=role)
                elif (assistant !=  role['role'] and manager !=  role['role'] and role['role'] != "chairman") :
...
def consider(id):
    ...
    try:
        ...
        tformat = '%H:%i'
        cursor.execute("SET lc_time_names = 'th_TH'")
        cursor.execute("SELECT *,date(now()) as today,TIME_FORMAT(current_time(), %s) as timenow,DATE_FORMAT(DATE_ADD(buy_date , INTERVAL 543 YEAR ), %s) as buydate,DATE_FORMAT(DATE_ADD(winner_date , INTERVAL 543 YEAR ), %s) as windate,DATE_FORMAT(DATE_ADD(prop_date , INTERVAL 543 YEAR ), %s) as propdate,DATE_FORMAT(DATE_ADD(report_date , INTERVAL 543 YEAR ), %s) as reportdate,DATE_FORMAT(DATE_ADD(nsm_project.process.conapp_date, INTERVAL 543 YEAR ), %s) as conappdate,DATE_FORMAT(DATE_ADD(DATE_ADD(nsm_project.process.conapp_date, INTERVAL 7 DAY), INTERVAL 543 YEAR), %s)  as conappend,DATEDIFF(ADDDATE(nsm_project.process.conapp_date, INTERVAL 7 DAY),date(now())) AS condiff,DATEDIFF(nsm_project.process.winner_date ,date(now())) AS windiff,DATE_FORMAT(DATE_ADD(startproject_date , INTERVAL 543 YEAR ), %s) as startdate, FORMAT(pj_amount, 0) as pjamount FROM nsm_project.projects LEFT JOIN nsm_project.process ON nsm_project.projects.pj_id = nsm_project.process.pj_id LEFT JOIN nsm_project.status_consider ON nsm_project.process.stcon_id = nsm_project.status_consider.stcon_id LEFT JOIN nsm_project.contractor ON nsm_project.process.contt_id = nsm_project.contractor.contt_id LEFT JOIN nsm_project.board ON nsm_project.projects.pj_id = nsm_project.board.pj_id AND nsm_project.board.bo_phase = 2 LEFT JOIN nsm_project.tbl_role ON nsm_project.board.role_id = nsm_project.tbl_role.role_id LEFT JOIN nsm_project.users ON nsm_project.board.user_id = nsm_project.users.user_id WHERE nsm_project.projects.pj_id = %s order by nsm_project.board.role_id", (tformat,format,format,format,format,format,format,format,id))
        row = cursor.fetchall()
        cursor.execute("SELECT * FROM nsm_project.projects LEFT JOIN nsm_project.manager ON nsm_project.projects.pj_id = nsm_project.manager.pj_id LEFT JOIN nsm_project.users ON nsm_project.manager.user_id = nsm_project.users.user_id WHERE nsm_project.projects.pj_id = %s ", id)
        rows = cursor.fetchall()
        ...
        cursor.execute("SELECT * FROM (SELECT null) a LEFT JOIN (SELECT nsm_project.board.bo_phase,CASE  WHEN nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id = nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 1 AND nsm_project.process.stdraft_id < 5 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id = nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 2 AND nsm_project.process.stcon_id < 7 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id = nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 3 AND nsm_project.process.stex_id < 6 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id != nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 1 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id != nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 2 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id != nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 3 THEN 'chairman' WHEN nsm_project.manager.user_id = nsm_project.users.user_id AND IF(nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id = nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 1 AND nsm_project.process.stdraft_id < 5 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id = nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 2 AND nsm_project.process.stcon_id < 7 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id = nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 3 AND nsm_project.process.stex_id < 6 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id != nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 1 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id != nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 2 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id != nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 3, 1, 0) = 0 THEN 'manager' WHEN nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.board.role_id = 2 THEN 'board' WHEN nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.board.role_id = 3 THEN 'assistant' END AS role FROM nsm_project.process LEFT JOIN nsm_project.manager ON nsm_project.process.pj_id = nsm_project.manager.pj_id LEFT JOIN nsm_project.board ON nsm_project.process.pj_id = nsm_project.board.pj_id LEFT JOIN nsm_project.tbl_role ON nsm_project.board.role_id = nsm_project.tbl_role.role_id LEFT JOIN nsm_project.users ON nsm_project.board.user_id = nsm_project.users.user_id or nsm_project.manager.user_id = nsm_project.users.user_id Where nsm_project.process.pj_id = %s and nsm_project.users.user_id = %s and nsm_project.board.bo_phase = 2 or nsm_project.process.pj_id = %s and nsm_project.users.user_id = %s and nsm_project.manager.user_id = nsm_project.users.user_id AND IF(nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id = nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 1 AND nsm_project.process.stdraft_id < 5 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id = nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 2 AND nsm_project.process.stcon_id < 7 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id = nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 3 AND nsm_project.process.stex_id < 6 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id != nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 1 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id != nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 2 OR nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.manager.user_id != nsm_project.users.user_id AND nsm_project.board.role_id = 1 AND nsm_project.board.bo_phase = 3, 1, 0) = 0 order by nsm_project.board.bo_phase desc,nsm_project.board.role_id asc  LIMIT 1) b ON true ",(id ,user,id,user))
        role = cursor.fetchone()
        if (manager ==  role['role']) :
            if (std == 5) :
...
@app.route('/project/<int:id>/considerdate', methods=['GET','POST'])
def considerdate(id):
    conn = None
    cursor = None
    try:
        stcon = request.form['stc']
        buyyd = request.form['buyyd']
        prod = request.form['prod']
        repd = request.form['repd']
        stc = int(stcon)
        if (stc <= 4 ):
            repd = '0000-00-00'
        sql = "UPDATE process SET buy_date=%s,prop_date=%s,report_date=%s WHERE pj_id=%s"
        data = (buyyd,prod,repd, id)
        conn = mysql.connect()
        cursor = conn.cursor()
        cursor.execute(sql, data)
        conn.commit()
...
def examine(id):
    ...
    try:
        ...
        ev = cursor.fetchall()
        cursor.execute("SELECT * FROM (SELECT null) a LEFT JOIN (SELECT nsm_project.checks.ins_date,DATE_FORMAT(DATE_ADD(check_date , INTERVAL 543 YEAR ), %s) as checkdate1,DATEDIFF(check_date,date(now())) AS checkdate FROM nsm_project.projects LEFT JOIN nsm_project.checks ON nsm_project.projects.pj_id = nsm_project.checks.pj_id   WHERE nsm_project.projects.pj_id = %s and  nsm_project.checks.ins_no = 1 ) b ON true",(format,id))
        one = cursor.fetchall()
        cursor.execute("SELECT * FROM (SELECT null) a LEFT JOIN (SELECT nsm_project.checks.ins_date,DATE_FORMAT(DATE_ADD(check_date , INTERVAL 543 YEAR ), %s) as checkdate1,DATEDIFF(check_date,date(now())) AS checkdate FROM nsm_project.projects LEFT JOIN nsm_project.checks ON nsm_project.projects.pj_id = nsm_project.checks.pj_id   WHERE nsm_project.projects.pj_id = %s and  nsm_project.checks.ins_no = 2 ) b ON true",(format,id))
        two = cursor.fetchall()
        cursor.execute("SELECT * FROM (SELECT null) a LEFT JOIN (SELECT nsm_project.checks.ins_date,DATE_FORMAT(DATE_ADD(check_date , INTERVAL 543 YEAR ), %s) as checkdate1,DATEDIFF(check_date,date(now())) AS checkdate FROM nsm_project.projects LEFT JOIN nsm_project.checks ON nsm_project.projects.pj_id = nsm_project.checks.pj_id   WHERE nsm_project.projects.pj_id = %s and  nsm_project.checks.ins_no = 3 ) b ON true",(format,id))
        three = cursor.fetchall()
        cursor.execute("SELECT * FROM (SELECT null) a LEFT JOIN (SELECT * FROM nsm_project.checks where nsm_project.checks.pj_id = %s and nsm_project.checks.ins_no = 1 ) b ON true",(id))
        check1 = cursor.fetchall()
        cursor.execute("SELECT * FROM (SELECT null) a LEFT JOIN (SELECT * FROM nsm_project.checks where nsm_project.checks.pj_id = %s and nsm_project.checks.ins_no = 2 ) b ON true",(id))
        check2 = cursor.fetchall()
        cursor.execute("SELECT * FROM (SELECT null) a LEFT JOIN (SELECT * FROM nsm_project.checks where nsm_project.checks.pj_id = %s and nsm_project.checks.ins_no = 3 ) b ON true",(id))
...
def  addboardd(id):
    ...
    row = cursor.fetchall()
    cursor.execute("SELECT * FROM (SELECT null) a LEFT JOIN (SELECT nsm_project.projects.pj_id,nsm_project.board.role_id,nsm_project.board.bo_id,nsm_project.tbl_role.role_name,nsm_project.users.user_fullname FROM nsm_project.projects LEFT JOIN nsm_project.board ON nsm_project.projects.pj_id = nsm_project.board.pj_id AND nsm_project.board.bo_phase = 1 LEFT JOIN nsm_project.tbl_role ON nsm_project.board.role_id = nsm_project.tbl_role.role_id LEFT JOIN nsm_project.users ON nsm_project.board.user_id = nsm_project.users.user_id LEFT JOIN nsm_project.office ON nsm_project.users.of_id = nsm_project.office.of_id LEFT JOIN nsm_project.division ON nsm_project.users.dv_id = nsm_project.division.dv_id WHERE nsm_project.projects.pj_id = %s and nsm_project.board.role_id != 3 order by nsm_project.board.role_id) b ON true order by b.role_id", id)
    row2 = cursor.fetchall()
    cursor.execute("SELECT * FROM (SELECT nsm_project.users.user_id,nsm_project.users.user_role,nsm_project.users.user_fullname,nsm_project.division.dv_shname FROM nsm_project.users LEFT JOIN nsm_project.division ON nsm_project.users.dv_id = nsm_project.division.dv_id) as a LEFT JOIN (SELECT nsm_project.board.user_id FROM nsm_project.projects LEFT JOIN nsm_project.board ON nsm_project.projects.pj_id = nsm_project.board.pj_id AND nsm_project.board.bo_phase = 1 LEFT JOIN nsm_project.users ON nsm_project.board.user_id = nsm_project.users.user_id WHERE nsm_project.projects.pj_id = %s ) as b ON a.user_id = b.user_id where (CASE when b.user_id = a.user_id then 0 else a.user_id end) != 0 and a.user_role != 'admin'", id)
    rows = cursor.fetchall()
    ...
    if(phase == role['bo_phase'] ):
        if (assistant == role['role']) :
            return render_template('addboardd.html', id=id,row=row,row2=row2,rows=rows,crole=crole)
    else:
        return render_template('inept.html', row=row , rows=rows ,id=id )
...
def addboardc(id):
    ...
    row = cursor.fetchall()
    cursor.execute("SELECT * FROM (SELECT null) a LEFT JOIN (SELECT nsm_project.projects.pj_id,nsm_project.board.role_id,nsm_project.board.bo_id,nsm_project.tbl_role.role_name,nsm_project.users.user_fullname FROM nsm_project.projects LEFT JOIN nsm_project.board ON nsm_project.projects.pj_id = nsm_project.board.pj_id AND nsm_project.board.bo_phase = 2 LEFT JOIN nsm_project.tbl_role ON nsm_project.board.role_id = nsm_project.tbl_role.role_id LEFT JOIN nsm_project.users ON nsm_project.board.user_id = nsm_project.users.user_id LEFT JOIN nsm_project.office ON nsm_project.users.of_id = nsm_project.office.of_id LEFT JOIN nsm_project.division ON nsm_project.users.dv_id = nsm_project.division.dv_id WHERE nsm_project.projects.pj_id = %s and nsm_project.board.role_id != 3 order by nsm_project.board.role_id) b ON true order by b.role_id", id)
    row2 = cursor.fetchall()
    cursor.execute("SELECT * FROM (SELECT nsm_project.users.user_id,nsm_project.users.user_role,nsm_project.users.user_fullname,nsm_project.division.dv_shname FROM nsm_project.users LEFT JOIN nsm_project.division ON nsm_project.users.dv_id = nsm_project.division.dv_id) as a LEFT JOIN (SELECT nsm_project.board.user_id FROM nsm_project.projects LEFT JOIN nsm_project.board ON nsm_project.projects.pj_id = nsm_project.board.pj_id AND nsm_project.board.bo_phase = 2 LEFT JOIN nsm_project.users ON nsm_project.board.user_id = nsm_project.users.user_id WHERE nsm_project.projects.pj_id = %s ) as b ON a.user_id = b.user_id where (CASE when b.user_id = a.user_id then 0 else a.user_id end) != 0 and a.user_role != 'admin'", id)
    rows = cursor.fetchall()
    ...
    if (assistant == role['role'] and stc > 1 and phase == role['bo_phase'] ) :
            return render_template('addboardc.html', id=id,row=row,row2=row2,rows=rows,crole=crole)
    else:
        return render_template('inept.html', row=row , rows=rows ,id=id )
...
def addboarde(id):
    ...
    row = cursor.fetchall()
    cursor.execute("SELECT * FROM (SELECT nsm_project.users.user_id,nsm_project.users.user_role,nsm_project.users.user_fullname,nsm_project.division.dv_shname FROM nsm_project.users LEFT JOIN nsm_project.division ON nsm_project.users.dv_id = nsm_project.division.dv_id) as a LEFT JOIN (SELECT nsm_project.board.user_id FROM nsm_project.projects LEFT JOIN nsm_project.board ON nsm_project.projects.pj_id = nsm_project.board.pj_id AND nsm_project.board.bo_phase = 3 LEFT JOIN nsm_project.users ON nsm_project.board.user_id = nsm_project.users.user_id WHERE nsm_project.projects.pj_id = %s ) as b ON a.user_id = b.user_id where (CASE when b.user_id = a.user_id then 0 else a.user_id end) != 0 and a.user_role != 'admin'", id)
    rows = cursor.fetchall()
...
def addeventc(id):
    ...
    cursor = conn.cursor(pymysql.cursors.DictCursor)
    tformat = '%H:%i'
    cursor.execute("SELECT *,date(now()) as today,TIME_FORMAT(current_time(), %s) as timenow FROM nsm_project.projects WHERE nsm_project.projects.pj_id = %s", (tformat,id))
    row = cursor.fetchall()
    cursor.execute("SELECT * FROM process WHERE pj_id=%s", id)
    rows = cursor.fetchall()
    stc = int(rows[0]['stcon_id'])
...
def editevent(id,idd,phase):
    ...
    cursor = conn.cursor(pymysql.cursors.DictCursor)
    tformat = '%H:%i'
    cursor.execute("SELECT *,TIME_FORMAT(ev_time, %s) as evtime FROM nsm_project.projects LEFT JOIN nsm_project.events ON nsm_project.projects.pj_id = nsm_project.events.pj_id WHERE nsm_project.projects.pj_id = %s AND nsm_project.events.ev_id = %s", (tformat,id,idd))
    row = cursor.fetchall()
...
def addProjectview():
    cursor = mysql.connect().cursor(pymysql.cursors.DictCursor)
    format = '%Y'
    cursor.execute("SELECT *,DATE_FORMAT(DATE_ADD(curdate(), INTERVAL 543 YEAR ), %s) as curyear,DATE_FORMAT(DATE_ADD(curdate(), INTERVAL 544 YEAR ), %s) as curyear1,DATE_FORMAT(DATE_ADD(curdate(), INTERVAL 545 YEAR ), %s) as curyear2,DATE_FORMAT(DATE_ADD(curdate(), INTERVAL 546 YEAR ), %s) as curyear3,DATE_FORMAT(DATE_ADD(curdate(), INTERVAL 547 YEAR ), %s) as curyear4 FROM office ORDER BY of_id",(format,format,format,format,format))
...
def addProject():
    ...
    try:
        ...
        sql1 = "INSERT INTO projects (pj_refNumber,of_id,dv_id,pj_name,pj_type,pj_amount,pj_detail,pj_budgetSource,pj_budgetYears,pj_status) VALUES(%s, %s, %s, %s,%s, %s, %s, %s, %s, %s)"
...
@app.route("/division1",methods=["POST","GET"])
def division1():
    conn = mysql.connect()
    cursor = conn.cursor()
    cursor = conn.cursor(pymysql.cursors.DictCursor)
    if request.method == 'POST':
        ...
        result = cursor.execute("SELECT * FROM  nsm_project.division LEFT JOIN nsm_project.office ON nsm_project.office.of_id=nsm_project.division.of_id WHERE nsm_project.division.of_id=%s ORDER BY dv_name ASC",of_id)
        division = cursor.fetchall() 
        OutputArray = []
        for result in division:
            outputObj = {
...
def editproject(id):
    ...
    conn = mysql.connect()
    cursor = conn.cursor(pymysql.cursors.DictCursor)
    cursor.execute("SELECT * FROM nsm_project.projects LEFT JOIN nsm_project.process ON nsm_project.projects.pj_id = nsm_project.process.pj_id WHERE nsm_project.projects.pj_id = %s ", (id))
    row = cursor.fetchall()
    std = int(row[0]['stdraft_id'])
    if (std == 1):
...
def addcontractor(id):
    ...
    try:
        ...
        cursor = conn.cursor()
        cursor = conn.cursor(pymysql.cursors.DictCursor)
        cursor.execute("SELECT max(contt_id),date(now()) as today FROM nsm_project.contractor;")
        row = cursor.fetchall()
...
def addcontractor2(id):
    ...
    try:
        ...
        if  contt_name and contt_address and contt_tel and contt_email and contt_fin and  request.method == 'POST':
            sql = "INSERT INTO contractor ( contt_name, contt_address, contt_tel, contt_email, contt_fin) VALUES( %s, %s, %s, %s, %s)"
...
def editcontractorveiw(id):
    ...
    try:
        ...
        cursor = conn.cursor()
        cursor = conn.cursor(pymysql.cursors.DictCursor)
        cursor.execute("SELECT *,date(now()) as today FROM nsm_project.process LEFT JOIN nsm_project.contractor ON nsm_project.process.contt_id =  nsm_project.contractor.contt_id WHERE pj_id=%s", id)
        row = cursor.fetchall()
        cursor.execute("SELECT pj_amount FROM projects WHERE pj_id=%s", id)
        rows = cursor.fetchall()
        cursor.execute("SELECT *,CASE WHEN nsm_project.manager.user_id = nsm_project.users.user_id THEN 'manager' WHEN nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.board.role_id = 1 OR nsm_project.board.role_id = 2 THEN 'board' WHEN nsm_project.board.user_id = nsm_project.users.user_id AND nsm_project.board.role_id = 3 THEN 'assistant' END AS role FROM nsm_project.projects LEFT JOIN nsm_project.manager ON nsm_project.projects.pj_id = nsm_project.manager.pj_id LEFT JOIN nsm_project.board ON nsm_project.projects.pj_id = nsm_project.board.pj_id LEFT JOIN nsm_project.tbl_role ON nsm_project.board.role_id = nsm_project.tbl_role.role_id LEFT JOIN nsm_project.users ON nsm_project.board.user_id = nsm_project.users.user_id or nsm_project.manager.user_id = nsm_project.users.user_id Where nsm_project.projects.pj_id = %s and nsm_project.users.user_id = %s group by nsm_project.users.user_id",(id ,user))
...
def editcontractor(id):
    ...
    try:
        ...
        if  contt_name and contt_address and contt_tel and contt_email and contt_fin and  request.method == 'POST':
            cursor = conn.cursor(pymysql.cursors.DictCursor)
            sql = "UPDATE contractor SET contt_name=%s, contt_address=%s, contt_tel=%s, contt_email=%s, contt_fin=%s WHERE contt_id=%s"
            data = (contt_name,contt_address,contt_tel,contt_email,contt_fin,contt_id)
            cursor.execute(sql, data)
            conn.commit()
            return redirect ('/project/'+str(id)+'/consider')
        else:
...
def addpacview(id):
    ...
    cursor = conn.cursor(pymysql.cursors.DictCursor)
    cursor.execute("SET lc_time_names = 'th_TH'")
    cursor.execute("SELECT *,curdate() as today,DATE_FORMAT(DATE_ADD(pac_date , INTERVAL 543 YEAR ), %s) as pacdate FROM nsm_project.pacel RIGHT JOIN nsm_project.projects ON nsm_project.projects.pj_id = nsm_project.pacel.pj_id WHERE nsm_project.projects.pj_id=%s ORDER BY pac_id DESC",(format,id))
    pac = cursor.fetchall()
...
def admin():
    if session['user_role']=="admin":
        ...
        try:
            ...
            cursor.execute("SELECT *,ROW_NUMBER() OVER(ORDER BY nsm_project.projects.pj_id) as row_num ,CAST(((stdraft_percent+stcon_percent+stex_percent)/3) AS DECIMAL(15, 2)) as x FROM nsm_project.projects LEFT JOIN nsm_project.process ON nsm_project.projects.pj_id = nsm_project.process.pj_id LEFT JOIN nsm_project.status_draft ON nsm_project.process.stdraft_id = nsm_project.status_draft.stdraft_id LEFT JOIN nsm_project.status_consider ON nsm_project.process.stcon_id = nsm_project.status_consider.stcon_id LEFT JOIN nsm_project.status_examine ON nsm_project.process.stex_id = nsm_project.status_examine.stex_id LEFT JOIN nsm_project.events ON nsm_project.projects.pj_id = nsm_project.events.pj_id LEFT JOIN nsm_project.contractor ON nsm_project.process.contt_id = nsm_project.contractor.contt_id LEFT JOIN nsm_project.manager ON nsm_project.projects.pj_id = nsm_project.manager.mn_id  LEFT JOIN nsm_project.users ON nsm_project.manager.user_id = nsm_project.users.user_id LEFT JOIN nsm_project.board ON nsm_project.projects.pj_id = nsm_project.board.pj_id where nsm_project.projects.pj_status=1 group by nsm_project.projects.pj_id order by nsm_project.projects.pj_id desc;")
            st1 = cursor.fetchall()
            cursor.execute("SELECT *,ROW_NUMBER() OVER(ORDER BY nsm_project.projects.pj_id) as row_num ,CAST(((stdraft_percent+stcon_percent+stex_percent)/3) AS DECIMAL(15, 2)) as x FROM nsm_project.projects LEFT JOIN nsm_project.process ON nsm_project.projects.pj_id = nsm_project.process.pj_id LEFT JOIN nsm_project.status_draft ON nsm_project.process.stdraft_id = nsm_project.status_draft.stdraft_id LEFT JOIN nsm_project.status_consider ON nsm_project.process.stcon_id = nsm_project.status_consider.stcon_id LEFT JOIN nsm_project.status_examine ON nsm_project.process.stex_id = nsm_project.status_examine.stex_id LEFT JOIN nsm_project.events ON nsm_project.projects.pj_id = nsm_project.events.pj_id LEFT JOIN nsm_project.contractor ON nsm_project.process.contt_id = nsm_project.contractor.contt_id LEFT JOIN nsm_project.manager ON nsm_project.projects.pj_id = nsm_project.manager.mn_id  LEFT JOIN nsm_project.users ON nsm_project.manager.user_id = nsm_project.users.user_id LEFT JOIN nsm_project.board ON nsm_project.projects.pj_id = nsm_project.board.pj_id where nsm_project.projects.pj_status=2 group by nsm_project.projects.pj_id order by nsm_project.projects.pj_id desc;")
            st2 = cursor.fetchall()
            cursor.execute("SELECT *,ROW_NUMBER() OVER(ORDER BY nsm_project.projects.pj_id) as row_num ,CAST(((stdraft_percent+stcon_percent+stex_percent)/3) AS DECIMAL(15, 2)) as x FROM nsm_project.projects LEFT JOIN nsm_project.process ON nsm_project.projects.pj_id = nsm_project.process.pj_id LEFT JOIN nsm_project.status_draft ON nsm_project.process.stdraft_id = nsm_project.status_draft.stdraft_id LEFT JOIN nsm_project.status_consider ON nsm_project.process.stcon_id = nsm_project.status_consider.stcon_id LEFT JOIN nsm_project.status_examine ON nsm_project.process.stex_id = nsm_project.status_examine.stex_id LEFT JOIN nsm_project.events ON nsm_project.projects.pj_id = nsm_project.events.pj_id LEFT JOIN nsm_project.contractor ON nsm_project.process.contt_id = nsm_project.contractor.contt_id LEFT JOIN nsm_project.manager ON nsm_project.projects.pj_id = nsm_project.manager.mn_id  LEFT JOIN nsm_project.users ON nsm_project.manager.user_id = nsm_project.users.user_id LEFT JOIN nsm_project.board ON nsm_project.projects.pj_id = nsm_project.board.pj_id where nsm_project.projects.pj_status=3 group by nsm_project.projects.pj_id order by nsm_project.projects.pj_id desc;")
            st3 = cursor.fetchall()
...
def adminEmployee():
    if session['user_role']=="admin":
        ...
        try:
            ...
            em = cursor.fetchall()
            cursor.execute("SELECT *,ROW_NUMBER() OVER(ORDER BY nsm_project.users.user_id) as row_num FROM nsm_project.users LEFT JOIN nsm_project.office ON nsm_project.users.of_id=nsm_project.office.of_id LEFT JOIN nsm_project.division ON nsm_project.users.dv_id=nsm_project.division.dv_id WHERE nsm_project.users.user_role='admin' order by nsm_project.users.user_id ")
            ad = cursor.fetchall()
            cursor.execute("SELECT *,count(case when nsm_project.users.user_role = 'admin' then 1 end) as cadmin,ROW_NUMBER() OVER(ORDER BY nsm_project.users.user_id) as row_num FROM nsm_project.users LEFT JOIN nsm_project.office ON nsm_project.users.of_id=nsm_project.office.of_id LEFT JOIN nsm_project.division ON nsm_project.users.dv_id=nsm_project.division.dv_id WHERE nsm_project.users.user_role='admin' order by nsm_project.users.user_id ")
            ad2 = cursor.fetchall()
            return render_template('adminEmployee.html',em=em,ad=ad,ad2=ad2)
        except Exception as e:
            print(e)
        finally:
            cursor.close() 
...
@app.route('/editOffice/<int:id>', methods=['POST'])
def editOffice(id):
    if session['user_role']=="admin":
        conn = None
        cursor = None
...
@app.route('/delete/office/<int:id>')
def deleteOffice(id):
    if session['user_role']=="admin":
        conn = None
        cursor = None
        try:
            conn = mysql.connect()
            cursor = conn.cursor()
            cursor.execute("DELETE FROM office WHERE of_id=%s", (id))
            cursor.execute("DELETE FROM division WHERE of_id=%s", (id))
            conn.commit()
...
def deleteDivision(id):
    if session['user_role']=="admin":
        ...
        try:
            conn = mysql.connect()
            cursor = conn.cursor()
            cursor.execute("DELETE FROM division WHERE dv_id=%s", (id))
            conn.commit()
            return redirect('/admin/office')
        except Exception as e:
            print(e)
...
def test2():
    ...
    try:
        ...
        cursor.execute("SELECT *,DATE_FORMAT(DATE_ADD(curdate(), INTERVAL 543 YEAR ), %s) as curyear,DATE_FORMAT(DATE_ADD(curdate(), INTERVAL 542 YEAR ), %s) as curyear1,DATE_FORMAT(DATE_ADD(curdate(), INTERVAL 541 YEAR ), %s) as curyear2,DATE_FORMAT(DATE_ADD(curdate(), INTERVAL 544 YEAR ), %s) as curyear11,DATE_FORMAT(DATE_ADD(curdate(), INTERVAL 545 YEAR ), %s) as curyear22 FROM office ORDER BY of_id",(format,format,format,format,format))
        office = cursor.fetchall()
        return render_template('test2.html', office=office )
    except Exception as e:
        print(e)
    finally:
        cursor.close() 
...
def adddatecontt(id):
    ...
    try:
        ...
        row = cursor.fetchall()
        cursor.execute("SELECT date(now()) as date FROM nsm_project.projects left join nsm_project.process on nsm_project.projects.pj_id = nsm_project.process.pj_id left join nsm_project.contractor on nsm_project.process.contt_id = nsm_project.contractor.contt_id WHERE nsm_project.projects.pj_id=%s", id)
        rows = cursor.fetchall()
        return render_template('adddatecontt.html',row=row,rows=rows)
    except Exception as e:
           print(e)
    finally:
           cursor.close() 
...
def adddatecontt2():
    ...
    try:
        ...
        cursor.execute(sql,data)
        conn.commit()
        return redirect('/examineup/'+str(pj_id))
    except Exception as e:
           print(e)
    finally:
           cursor.close() 
...
def editdatecontt(id):
    ...
    try:
        ...
        cursor.execute("SELECT date(now()) as date FROM nsm_project.projects left join nsm_project.process on nsm_project.projects.pj_id = nsm_project.process.pj_id left join nsm_project.contractor on nsm_project.process.contt_id = nsm_project.contractor.contt_id WHERE nsm_project.projects.pj_id=%s", id)
        rows = cursor.fetchall()
        return render_template('editdatecontt.html',row=row,rows=rows)
    except Exception as e:
           print(e)
    finally:
           cursor.close() 
